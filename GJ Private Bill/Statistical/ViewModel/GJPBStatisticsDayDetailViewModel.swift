//
//  GJPBStatisticsDayDetailViewModel.swift
//  GJ Private Bill
//
...
struct GJPBStatisticsDayDetailViewModel {
    let time: String
    ...
    mutating func cellMsg(indexPath: IndexPath) -> GJPBStatisticsDayDetailViewModel {
...
extension GJPBStatisticsDayDetailViewModel: GJPBMainTableViewCellDataSource {
